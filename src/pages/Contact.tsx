        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12 lg:py-16 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-6 sm:mb-8 md:mb-12 px-2 sm:px-4 py-8 sm:py-12 rounded-2xl mx-2 sm:mx-4" style={{
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-2 sm:mb-3 md:mb-4 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 text-white drop-shadow-lg">
                <Mail className="h-6 w-6 sm:h-8 sm:w-8 md:h-10 md:w-10 text-yellow-300" />
                <span className="break-words">Contact Information</span>
              </h1>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-6 md:mb-8 px-2 sm:px-4 text-white/90">Let's connect and create something amazing together</p>
            ...
            <Card className="hover:shadow-2xl transition-all duration-300 border-2" style={{ 
              ...
              <CardContent className="p-6 sm:p-8 md:p-12 text-center relative overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-10">
                  <div className="absolute top-0 left-0 w-32 h-32 sm:w-40 sm:h-40 rounded-full animate-pulse" style={{ backgroundColor: '#D4AF37' }}></div>
                  <div className="absolute bottom-0 right-0 w-32 h-32 sm:w-40 sm:h-40 rounded-full animate-pulse" style={{ backgroundColor: '#6AA84F' }}></div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 sm:w-64 sm:h-64 rounded-full animate-pulse" style={{ backgroundColor: '#F5F1E8' }}></div>
                </div>
                
                <div className="relative z-10">
                  <div className="inline-flex items-center justify-center w-14 h-14 sm:w-18 sm:h-18 md:w-20 md:h-20 rounded-full mb-4 sm:mb-6 border-4 shadow-2xl" style={{ 
                    background: `linear-gradient(135deg, #D4AF37 0%, #F4D03F 100%)`,
                    borderColor: 'rgba(255,255,255,0.5)',
                    width: '4.5rem',
                    height: '4.5rem'
                  ...
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 px-2 text-white drop-shadow-lg">
                  ...
                  <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 md:gap-8 mt-6 sm:mt-8 md:mt-10 pt-6 sm:pt-8 border-t" style={{ borderColor: 'rgba(255,255,255,0.2)' }}>
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <span className="text-xs sm:text-sm font-medium whitespace-nowrap text-white">Quick Response</span>
                    </div>
                    <div className="flex items-center justify-center gap-2">
                      <CheckCircle2 className="h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0 text-green-400" />
                      <span className="text-xs sm:text-sm font-medium whitespace-nowrap text-white">Professional Service</span>
                    </div>
                    <div className="flex items-center justify-center gap-2">
                      <CheckCircle2 className="h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0 text-green-400" />
