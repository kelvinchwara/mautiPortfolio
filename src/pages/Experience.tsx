...
<<<<<<< HEAD
  <div className="text-center mb-8 sm:mb-12 px-4 py-8 sm:py-12 rounded-2xl mx-2 sm:mx-4" style={{
    ...
    <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 text-white drop-shadow-lg">
      <Activity className="h-8 w-8 sm:h-10 sm:w-10 text-yellow-300" />
      <span>Work Experience</span>
    </h1>
    <p className="text-base sm:text-lg md:text-xl mb-4 sm:mb-6 px-4 text-white/90">
...
<<<<<<< HEAD
    ...
    style={{ 
      ...
      background: `linear-gradient(135deg, ${COLORS.secondary} 0%, ${COLORS.primary} 50%, ${COLORS.background} 100%)`
    }}
  >
...
<<<<<<< HEAD
        ...
        <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 px-4 text-white drop-shadow-lg">
          <Sparkles className="h-6 w-6 sm:h-8 sm:w-8 flex-shrink-0 text-yellow-300" />
