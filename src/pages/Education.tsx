        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12 md:mb-16 relative px-4 py-8 sm:py-12 rounded-2xl mx-2 sm:mx-4" style={{
            ...
            <div className="relative inline-block mb-4 sm:mb-6">
              ...
              <div className="relative inline-flex items-center justify-center w-18 h-18 sm:w-22 sm:h-22 md:w-26 md:h-26 rounded-full border-4 shadow-2xl" style={{ 
                background: `linear-gradient(135deg, ${COLORS.GOLD} 0%, #F4D03F 50%, #D4AF37 100%)`,
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-3 sm:mb-4 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 text-white drop-shadow-lg">
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6">
              <div className="px-3 py-1.5 sm:px-4 sm:py-2 rounded-full border-2 text-xs sm:text-sm font-medium text-white" style={{ borderColor: 'rgba(255,255,255,0.3)', backgroundColor: 'rgba(255,255,255,0.1)' }}>
                <GraduationCap className="inline h-3 w-3 sm:h-4 sm:w-4 mr-1" />
                2 Degrees
              </div>
              <div className="px-3 py-1.5 sm:px-4 sm:py-2 rounded-full border-2 text-xs sm:text-sm font-medium text-white" style={{ borderColor: 'rgba(255,255,255,0.3)', backgroundColor: 'rgba(255,255,255,0.1)' }}>
...
<p className="text-xs sm:text-sm text-gray-700 break-words">Focusing on leadership, technology integration, and innovative teaching</p>
          ...
          <Card className="relative overflow-hidden shadow-2xl border-2" style={{ 
            ...
            <div className="absolute inset-0 opacity-10 pointer-events-none">
              <div className="absolute top-0 left-0 w-32 h-32 sm:w-40 sm:h-40 rounded-full animate-pulse" style={{ backgroundColor: COLORS.GOLD }}></div>
              <div className="absolute bottom-0 right-0 w-32 h-32 sm:w-40 sm:h-40 rounded-full animate-pulse" style={{ backgroundColor: COLORS.FOREST_GREEN }}></div>
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 sm:w-64 sm:h-64 rounded-full animate-pulse" style={{ backgroundColor: COLORS.CREAM }}></div>
            </div>
            ...
            <CardContent className="p-6 sm:p-8 md:p-12 text-center relative z-10">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 px-4 text-black drop-shadow-lg">
