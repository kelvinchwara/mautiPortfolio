  ...
  <div className="mb-12 sm:mb-16 md:mb-20 pt-12 sm:pt-16 pb-8 sm:pb-12 bg-white rounded-3xl shadow-2xl border-t-8 relative overflow-hidden"
    ...
    <div className="flex flex-col md:flex-row items-center max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
      ...
      <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-56 md:h-56 flex-shrink-0 mb-6 sm:mb-8 md:mb-0 md:mr-10 relative">
        ...
        >
          <Brain className="h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24" />
        </div>
      ...
      <div className="text-center md:text-left">
        ...
        <p className="text-base sm:text-lg md:text-xl text-gray-700 mb-4 sm:mb-6 max-w-xl mx-auto md:mx-0 leading-relaxed">
          A comprehensive skill set built through over a decade of dedicated teaching and continuous professional development in
          <strong className="relative inline-block" style={{ color: COLORS.FOREST_GREEN }}>
            <Lightbulb className="inline h-4 w-4 sm:h-5 sm:w-5 mr-1" />
            Mathematics Education
          </strong> across international curricula.
        </p>
...
const HighlightsSection: React.FC = () => (
  <div className="mb-16">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
      <StatsCard value="10+" label="Years Experience" icon={Clock} color={COLORS.BRONZE_LIGHT} />
      <StatsCard value="1000+" label="Students Taught" icon={Users} color={COLORS.FOREST_GREEN} />
      <StatsCard value="4+" label="Institutions" icon={Building2} color={COLORS.GOLD} />
      <StatsCard value="3" label="Countries" icon={Globe} color={COLORS.BRONZE_DARK} />
    </div>
  </div>
);
