...
<<<<<<< HEAD
      <header className="relative overflow-hidden px-4 sm:px-6 lg:px-8" style={{ background: `linear-gradient(135deg, ${COLORS.CREAM} 0%, ${COLORS.BEIGE}80 50%, ${COLORS.CREAM} 100%)` }}>
        <div className="absolute inset-0 opacity-20">
          ...
          <div className="absolute bottom-10 left-10 w-24 sm:w-48 h-24 sm:h-48 rounded-full animate-pulse" style={{ backgroundColor: COLORS.FOREST_GREEN }}></div>
          <div className="absolute top-20 left-20 w-16 sm:w-32 h-16 sm:h-32 rounded-full opacity-70 animate-bounce [animation-delay:1s]" style={{ backgroundColor: COLORS.BRONZE_LIGHT }}></div>
          <div className="absolute bottom-20 right-20 w-20 sm:w-40 h-20 sm:h-40 rounded-full opacity-50 animate-ping [animation-duration:4s]" style={{ backgroundColor: COLORS.GOLD }}></div>
        </div>
        
        <div className="max-w-6xl mx-auto py-12 sm:py-16 md:py-20 lg:py-24 relative z-10">
          <div className="text-center mb-6 sm:mb-8">
        <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl mb-6 sm:mb-8 shadow-lg animate-pulse [animation-duration:3s] hover:animate-none backdrop-blur-sm border" style={{ 
          background: `linear-gradient(135deg, ${COLORS.BRONZE_LIGHT}20, ${COLORS.GOLD}10)`, 
          borderColor: `${COLORS.BEIGE}40`,
          boxShadow: `0 8px 32px ${COLORS.GOLD}20`
        }}>
          <Award className="h-4 w-4 sm:h-5 sm:w-5 drop-shadow-lg" style={{ color: COLORS.GOLD }} />
          <span className="text-xs sm:text-sm font-semibold tracking-wide" style={{ color: COLORS.BRONZE_DARK, textShadow: '0 1px 2px rgba(0,0,0,0.1)' }}>Professional Development Hub</span>
        </div>
            
        <h1 
          className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-black mb-4 sm:mb-6 bg-clip-text bg-gradient-to-r animate-scale-in leading-tight"
          style={{ 
            backgroundImage: `linear-gradient(135deg, ${COLORS.BRONZE_DARK}, ${COLORS.GOLD}, ${COLORS.FOREST_GREEN})`,
        ...
        <p 
          className="text-lg sm:text-xl lg:text-2xl font-semibold max-w-4xl mx-auto px-4 sm:px-8 py-6 sm:py-8 my-4 sm:my-6 rounded-3xl shadow-2xl backdrop-blur-md border animate-fade-in-up leading-[1.75] tracking-wide"
          style={{ 
            backgroundColor: `${COLORS.CREAM}D0`,
            borderColor: `${COLORS.BEIGE}80`,
            boxShadow: `0 20px 40px ${COLORS.BRONZE_LIGHT}30, inset 0 1px 0 ${COLORS.GOLD}20`
          }}
        >
          A curated collection of my achievements, certifications, teaching resources, and professional development materials.
        </p>
        <div className="h-1 sm:h-1.5 w-0 mx-auto mt-6 sm:mt-8 rounded-full animate-gradient-width shadow-lg" style={{ 
